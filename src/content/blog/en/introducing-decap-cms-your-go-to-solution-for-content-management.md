---
title: Introducing Decap CMS Your New Website for Content Management
draft: false
author: Milen Doe
image:
  src: /images/decapcms.png
  alt: Decap CMS
snippet: Snippet Decap CMS, formerly known as Netlify CMS, is an open-source content management system offering developers a seamless way to manage content for static site generators.
...
tags:
  ...
  - test
---
Decap CMS TEST, formerly known as Netlify CMS, is an open-source content management system that offers developers a seamless way to manage content for static site generators.
